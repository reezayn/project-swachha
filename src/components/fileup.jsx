...
function FileWindow() {
    ...
    return (
        <div className="flex-row items-center justify-start">
            <h1 className="w-full my-4 text-4xl font-extrabold text-center">Waste detection multiplyer </h1>
            ...
            <div className="w-full px-10 my-10">
                <form className="flex justify-center">
                    ...
                    <button onClick={handleURLSubmit} className="p-4 mx-5 text-white rounded-full bg-primary dark:bg-primary-dark"><BsSendCheckFill size={25} /></button>
                </form>
            </div>
